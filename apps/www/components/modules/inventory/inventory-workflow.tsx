...
const STAGES = ["Catalog", "Stock", "Sell", "Alert", "Restock"] as const;
      ...
      <div className="container-site grid items-center gap-12 lg:grid-cols-12 lg:gap-16">
        <FadeIn className="lg:col-span-5">
          ...
          <h2 className="mt-3 text-3xl font-extrabold tracking-tight text-[#1a2744] sm:text-4xl">
            Define what you sell once. Use it everywhere.
          </h2>
          <div className="mt-5 space-y-4 text-base leading-relaxed text-muted-foreground">
            <p>
              Inventory is the product brain of Modufy. One catalog feeds invoices, POS, appointments,
              and your storefront.
            </p>
            <p>
              Low-stock alerts, supplier records, and purchase orders keep retail and wholesale teams
              ahead of stockouts.
            </p>
            <p>Services live alongside products — hourly, fixed, or bookable — without a second system.</p>
          </div>
        </FadeIn>
