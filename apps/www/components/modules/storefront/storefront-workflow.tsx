...
const STAGES = ["Publish", "Browse", "Order", "Enquiry", "Review"] as const;

export function StorefrontWorkflow() {
      ...
      <div className="container-site grid items-center gap-12 lg:grid-cols-12 lg:gap-16">
        <FadeIn className="lg:col-span-5">
          ...
          <div className="mt-5 space-y-4 text-base leading-relaxed text-muted-foreground">
            <p>
              Your storefront adapts to product shops and service businesses from the same Inventory
              catalog you already manage.
            </p>
            <p>
