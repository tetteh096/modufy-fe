...
const STAGES = ["Customers", "Sales", "Expenses", "Team", "Alerts"] as const;
      ...
      <div className="container-site grid items-center gap-12 lg:grid-cols-12 lg:gap-16">
        <FadeIn className="lg:col-span-5">
          ...
          <div className="mt-5 space-y-4 text-base leading-relaxed text-muted-foreground">
            ...
            <p>
              Paid modules plug into Core instead of replacing it. A POS sale, invoice payment, and
              storefront order all land in the same financial picture.
            </p>
            <p>Replace spreadsheets first. Grow into billing, stock, and more when you are ready.</p>
          </div>
        </FadeIn>
